...
public class Locators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Css selectors -> Class name -> tagname.classname -> button.signInBtn
        ...
        Thread.sleep(1000); // wait 1s before clicking a reset button // something to get in a stable state
        driver.findElement(By.xpath("//input[@placeholder = 'Name']")).sendKeys("John");
        driver.findElement(By.cssSelector("input[placeholder = 'Email']")).sendKeys("john@rsa.com");
        driver.findElement(By.xpath("//input[@type = 'text'][2]")).clear();
        driver.findElement(By.cssSelector("input[type = 'text']:nth-child(3)")).sendKeys("john@gmail.com");
        driver.findElement(By.xpath("//form/input[3]")).sendKeys("1894646");
